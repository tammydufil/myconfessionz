        ...
        <div className="mb-4 bg-white py-3 px-2 rounded">
          <div className="flex">
            <div className="h-[40px] w-[40px] flex items-center justify-center bg-[red] rounded-full text-[white] font-bold uppercase pt-1">
              {pageReply?.user?.usercode?.charAt(0)}
              {pageReply?.user?.usercode?.charAt(1)}
            </div>
            <div className="ml-3">
              <h5 className="text-[red] font-bold capitalize">
                {pageReply?.user?.usercode}, {pageReply?.user?.gender}, {age}{" "}
                {age > 2 ? "years" : "year"}
              </h5>
          ...
          <h4 className="text-xl ml-[50px] leading-6">{item.user_reply}</h4>
