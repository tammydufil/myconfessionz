  ...
  return user !== undefined || username !== undefined ? (
    <div>
      ...
      <div className="mt-[120px] px-[30px] md:px-[60px] text-[red]">
        <div className=" text-3xl md:text-5xl">Terms & Conditions</div>

        <div className="italic mt-2 ml-2 text-lg">Updated at 2022-12-26</div>
        <div className=" text-3xl mt-5">General Terms</div>
        ...
        <div className=" text-3xl mt-5">License</div>

        <p className="mt-3 leading-5 text-lg">
          Myconfessionz grants you a revocable, non-exclusive, non-
          transferable, limited license to download, install and use our service
          strictly in accordance with the terms of this Agreement.
        </p>
        <p className="mt-3 leading-5 text-lg">
          These Terms & Conditions are a contract between you and Myconfessionz
          (referred to in these Terms & Conditions as "Myconfessionz", "us",
          "we" or "our"), the provider of the Myconfessionz website and the
          services accessible from the Myconfessionz website (which are
          collectively referred to in these Terms & Conditions as the
          "Myconfessionz Service").
        </p>
        <p className="mt-3 leading-5 text-lg">
        ...
        <p className="mt-3 leading-5 text-lg">For this Terms & Conditions:</p>
        ...
        <div className=" text-3xl mt-5">Restrictions</div>
        ...
        <ul className="list-outside">
          <li className="leading-5 text-lg mt-3 ">
        ...
        <div className=" text-3xl mt-5">Payment</div>
        ...
        <p className="mt-4 leading-5 text-lg ">
          ...
          an order form, you must provide us with a valid credit card (Visa,
          ...
          Provider. By providing us with your credit card number and associated
          ...
          notify us of any change in your billing address or the credit card
          used for payment hereunder. We reserve the right at any time to change
          its prices and billing methods, either immediately upon posting on our
          ...
          paid for by you. No contract will exist between you and us for the
        ...
        <div className=" text-3xl mt-5">Return and Refund Policy</div>
        ...
        <p className="mt-4 leading-5 text-lg ">
          ...
          products. <br /> <br /> As with any shopping experience, there are
          terms and conditions that apply to transactions at our company. We’ll
          ...
          the terms along with our Privacy Policy. <br /> <br /> If, for any
          reason, You are not completely satisfied with any good or service that
          we provide, don't hesitate to contact us and we will discuss any of
          the issues you are going through with our product.
        </p>

        <div className=" text-3xl mt-5">Your Suggestions</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Changes To Our Terms & Conditions</div>
        <p className="mt-4 leading-5 text-lg ">
          ...
          we decide to change our Terms & Conditions, we will post those changes
          on this page, and/or update the Terms & Conditions modification date
          below.
        </p>
        <div className=" text-3xl mt-5">Modifications to Our service</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Updates to Our service</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Term and Termination</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Indemnification</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">No Warranties</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Limitation of Liability</div>
        <p className="mt-4 leading-5 text-lg ">
          ...
          the amount actually paid by you for the service. To the maximum extent
          ...
          interruption, for personal injury, for loss of privacy arising out of
        ...
        <div className=" text-3xl mt-5">Severability</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Waiver</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Amendments to this Agreement</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Entire Agreement</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Updates to Our Terms</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Intellectual Property</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Agreement to Arbitrate</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Notice of Dispute</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Binding Arbitration</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Submissions and Privacy</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Promotions</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Typographical Errors</div>
        <p className="mt-4 leading-5 text-lg ">
        ...
        <div className=" text-3xl mt-5">Miscellaneous</div>
        <p className="mt-4 leading-5 text-lg ">
          ...
          surety) in the event of any breach or anticipatory breach by you. We
          operate and control our Service from our offices in . The Service is
          ...
          to access our Service from other locations do so on their own
        ...
        <div className=" text-3xl mt-5">Disclaimer</div>
        <p className="mt-4 leading-5 text-lg ">
